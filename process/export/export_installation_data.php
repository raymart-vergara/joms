...
$fields_exp = array('Request ID', 'Status', 'Ex. Mazda', 'Ex. J12SRHD', 'Ex.123', 'Ex. DA-123', 'Ex.', 'Ex.Assy jig', 'Ex.123', 'Ex. EV-MP Set up', 'Ex.12345', 'Ex. YYYY-MM-DD', 'Ex. Juan', 'Ex. YYYY-MM-DD', 'Example','Ex. YYYY-MM-DD', 'RFQ No','Ex. YYYY-MM-DD','Ex. YYYY-MM-DD', 'LEADTIME(based on quotation)', 'Quotation No ', 'Unit Price JPY ', 'Unit Price USD', 'Unit Price USD','Total Amount ', 'FSIB No. ', 'FSIB Code ', 'Ex. YYYY-MM-DD', 'Ex. YYYY-MM-DD', 'Ex. YYYY-MM-DD', 'Ex. YYYY-MM-DD', 'Ex. YYYY-MM-DD', 'Ex. YYYY-MM-DD','Ex. YYYY-MM-DD', 'PO No. ', 'Ordering Additional Details ', 'Supplier ', 'Ex. YYYY-MM-DD', 'Ex. YYYY-MM-DD', 'Ex. YYYY-MM-DD', 'Invoice No ', 'Classification ', 'Remarks ', 'Ex. YYYY-MM-DD');
