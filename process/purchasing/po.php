...
if ($method == 'fetch_request_with_po') {
	$c = 0;
...
//po
				...
				// echo '<td>'.$j['car_model_for_formula'].'</td>';
				echo '<td>'.$j['supplier'].'</td>';
				// echo '<td>'.$j['start_of_usage'].'</td>';
				// echo '<td>'.$j['required_delivery_date2'].'</td>';
				echo '<td>'.$j['etd'].'</td>';
				echo '<td>'.$j['eta'].'</td>';
...
} else if ($method == 'get_closed_request_history') {
